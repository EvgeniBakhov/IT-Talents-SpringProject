...
public class BookingDAO {
    ...
    private static final String GET_BOOKINGS_BETWEEN_DATES_SQL = "SELECT id, stay_id, user_id, from_date, to_date," +
            " accepted, valid FROM bookings WHERE stay_id = ? AND ((from_date BETWEEN ? AND ?) " +
    ...
    public List<Booking> getBookingsBetweenDates(long stayId, LocalDate fromDate, LocalDate toDate) throws SQLException {
        try(Connection connection = jdbcTemplate.getDataSource().getConnection();
